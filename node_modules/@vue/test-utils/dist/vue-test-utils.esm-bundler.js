...
/**
 * @vue/test-utils v2.0.0-rc.9
 * (c) 2021 Lachlan Miller
 * Released under the MIT License
 */

import * as vue from 'vue';
import { nextTick, setDevtoolsHook, getCurrentInstance, reactive, defineComponent, h, transformVNodeArgs, Transition, TransitionGroup, createApp } from 'vue';
...
function isFunctionalComponent$1(component) {
...
var isFunctionalComponent = function (type) {
...
function stubComponents(stubs, shallow, renderStubDefaultSlot) {
    ...
    transformVNodeArgs(function (args, instance) {
        ...
        if (isComponent(type) || isFunctionalComponent(type)) {
            ...
            var componentName = type['name'] || type['displayName'];
            // No name found?
...
function mount(originalComponent, options) {
    ...
    var component;
    if (isFunctionalComponent$1(originalComponent)) {
